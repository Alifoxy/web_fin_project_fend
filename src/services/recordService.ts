...
const recordService = {
    ...
    createRecord: (body: INewRecord ): IRes<INewRecord> => apiService.post(urls.records.base, body),
    createNew: (body: INewRecord ): IRes<INewRecord> => apiService.post(urls.records.createNew, body),
